<section class="cuf">
  <div class="contact1">
    <div class="container cuf-box">
      <div class="row cuf-form">
        <div class="col-md-6 d-flex align-items-start justify-content-center">
          <div class="cuf-text ">
            <p class="cuf-p1">why choose us</p>
            <h2>have any question?</h2>
            <h1>feel free to contact us</h1>
            <p class="cuf-p2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, nemo.</p>
            <p class="cuf-p3">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit.
              Autem quisquam est rerum corporis excepturi, commodi porro quaerat vitae quod odio?
            </p>
          </div>
        </div>
        <div class="col-md-6">
          <form class="contact1-form validate-form" action="" method="POST">
            ...
            <div class="wrap-input1 wrap-textarea validate-input" data-validate="Message is required">
