...
<nav class="<?php echo $navClass; ?> navbar-expand-lg col-lg-12" id="bottomNav">
    <div class="container-fluid">
        <div class="mob-logo">
            <a class="navbar-brand" href="index.php"><img src="assets/images/Logo-02.png" alt="" /></a>
        </div>
            ...
            <ul class="navbar-nav nav-1">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item <?= $activePage == "brandingandidentity.php" ? 'active' : '' ?>" href="brandingandidentity.php">Branding & Identity</a></li>
                        <li><a class="dropdown-item <?= $activePage == "onlyfansmanagement.php" ? 'active' : '' ?>" href="onlyfansmanagement.php">Onlyfans Management</a></li>
                        <li><a class="dropdown-item <?= $activePage == "socialmediamarketing.php" ? 'active' : '' ?>" href="socialmediamarketing.php">Social Media Marketing</a></li>
                        <li><a class="dropdown-item <?= $activePage == "contentstrategy.php" ? 'active' : '' ?>" href="contentstrategy.php">Content Creation & Strategy</a></li>
                        <span class="drop-arrow"><ion-icon name="caret-down-outline" class="drop-ico"></ion-icon></span>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $activePage == "about-us.php" ? 'active' : '' ?>" href="about-us.php">About Us</a>
                </li>
            </ul>
            <div class="web-logo">
                <a class="navbar-brand" href="index.php"><img src="assets/images/footer-logo.png" alt="" /></a>
            </div>
...
<aside class="sidebar">
    ...
    <div class="side-inner">
        <div class="profile">
            <a href="index.php"><img src="assets/images/Logo-02.png" alt="Image" class="img-fluid" /></a>
        </div>

        <div class="nav-menu">
            <ul>
                <li class="<?= $activePage == "index.php" ? 'active' : '' ?>">
                    <a href="index.php"><span class="icon-home mr-3"></span>Home</a>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="<?= $activePage == "brandingandidentity.php" ? 'active' : '' ?>">
                            <a href="brandingandidentity.php">Branding & Identity</a>
                        </li>
                        ...
                        <li class="<?= $activePage == "contentstrategy.php" ? 'active' : '' ?>">
                            <a href="contentstrategy.php">Content Creation & Strategy</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li class="<?= $activePage == "about-us.php" ? 'active' : '' ?>">
                    <a href="about-us.php"><span class="icon-pie-chart mr-3"></span>About Us</a>
                </li>
                <li class="<?= $activePage == "contact.php" ? 'active' : '' ?>">
                    <a href="contact.php"><span class="icon-pie-chart mr-3"></span>Contact Us</a>
                </li>
                <li class="<?= $activePage == "faq.php" ? 'active' : '' ?>">
                    <a href="faq.php"><span class="icon-sign-out mr-3"></span>F A Q</a>
                </li>
            </ul>
        </div>
    </div>
